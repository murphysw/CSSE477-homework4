...
public class Protocol {
	 ...
	 * Rather than reading the whole file at once, we divide the reading of the
	 * file into number of small chunk of bytes and send each chunk to the
	 * socket to utilize the memory better.
	 */
	...
	public static String getServerInfo() {
		...
		String osVersion = System.getProperty("os.version"); // e.g. 10.5,
																// 10.0.4, etc
		String architecture = System.getProperty("os.arch"); // e.g. i386,
																// x86_64, etc
		String serverInfo = Protocol.SERVER_INFO + Protocol.SPACE + "(" + os
				+ Protocol.SLASH + osVersion + Protocol.SLASH + architecture
				+ ")";
		return serverInfo;
	}
}
